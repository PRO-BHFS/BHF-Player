import 'package:bhf_player/bhf_studio/lib/features/course/domain/entities/admin_course_storage.dart';
import 'package:bhf_player/bhf_studio/lib/features/course/domain/entities/course.dart';
import 'package:bhf_player/bhf_studio/lib/features/course/domain/usecases/add_course.dart';
import 'package:bhf_player/bhf_studio/lib/features/course/domain/usecases/delete_course.dart';
import 'package:bhf_player/bhf_studio/lib/features/course/domain/usecases/reset_courses_id.dart';
import 'package:bhf_player/bhf_studio/lib/features/course/domain/usecases/update_course.dart';
...
class AdminCourseCubit extends HydratedCubit<AdminCourseState> {
  AdminCourseCubit() : super(CourseInitial());
  ...
  String get currentEncryptionCode => _currentCourse?.encryptionCode ?? 'none';
  ...
  @override
  AdminCourseState? fromJson(Map<String, dynamic> json) {
    try {
      emit(CourseLoading());
      final courseStorage = AdminCourseStorage.fromJson(json);
  ...
  @override
  Map<String, dynamic>? toJson(AdminCourseState state) {
    final courseStorage = AdminCourseStorage(
      courses: _courses,
